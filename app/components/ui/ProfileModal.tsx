      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-[1000px] h-[85vh] bg-white rounded-[24px] shadow-2xl z-[999] overflow-hidden flex flex-col"
          >
