  ...
  return (
    <main className="pt-4 flex flex-col justify-center items-center w-screen page-gradient scroll-smooth">
      ...
      <ProjectHeader
        ...
        team="Solo project"
        tools={["Figma, XCode,", "ShortCuts, Claude Code"]}
        link="/fore"
      />
        ...
        <div className="flex-[9] pt-12 md:pt-0">
          ...
          >
            ...
            >
              <h3>Overview</h3>
              <div>
                <b>FO/RE</b> <i>Focus on your work. Rest on your life.</i>
                <br />
                <br />
                <b>
                  A physical card. One tap. Your entire digital environment
                  shifts.
                </b>
                <br />
                <br />
                Most productivity tools solve the wrong problem. They add more
                to manage — timers, blockers, notification settings — when the
                real issue is simpler: remote workers have lost the
                environmental signal that tells the brain when work begins and
                when it ends.
                <br />
                <br />
                FO/RE is a hybrid iOS app and NFC system that turns a single
                physical gesture into a behavioral ritual. Tap in. Work mode
                activates. Tap out. It's over.
                <br />
                <br />
                Built with Xcode and Apple Shortcuts. Designed over one year,
          ...
          >
            ...
            >
              ...
              <div>
                <p>
                  The brain needs a signal to switch contexts. Remote work took
                  it away.
                </p>
                <br />
                <p>
                  When you commute, your environment tells your brain when to
                  work and when to stop. However, remote work removed that
                  signal entirely.
                </p>
                <br />
                <div className="flex gap-12 flex-col md:flex-row">
                  <div className="flex flex-col items-left border border-white bg-white/50 text-white p-10 flex-1 rounded-2xl">
                    <h4 className="text-7xl font-bold text-[#6D8EEB] font-archivo">
                      69%
                    </h4>
                    <p className="text-lg text-black">
                      of remote workers report burnout from{" "}
                      <b>blurred work boundaries.</b>
                    </p>
                  </div>
                  <div className="flex flex-col items-left border border-white bg-white/50 text-white p-10 flex-1 rounded-2xl">
                    <h4 className="text-7xl font-bold text-[#6D8EEB] font-archivo">
                    ...
                    <p className="text-lg text-black">
                      of remote/hybrid workers{" "}
                      <b>use their bedroom or living room</b> for work.
                    </p>
                  </div>
                </div>
                <br />
                <p>
                  But the cause isn't overwork or lack of discipline — it's the
                  absence of a transition. <br />There's no door to close. No physical
                  moment that separates one context from another.
                </p>
              </div>
            </article>
            ...
            >
              ...
              <div className="flex gap-12 flex-col md:flex-row">
                <div className="flex flex-col items-center border border-white bg-white/50 text-white p-10 flex-1 rounded-2xl">
                  <h4 className="text-6xl text-bold text-[#6D8EEB] pb-5">①</h4>
